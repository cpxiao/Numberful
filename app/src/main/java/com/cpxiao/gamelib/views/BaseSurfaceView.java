...
public abstract class BaseSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
        ...
        try {
            if (mSurfaceHolder != null && mBitmapCache != null && mPaint != null) {
                ...
                if (mShader != null) {
                    ...
                    mCanvasCache.drawPaint(mBgPaint);
                }

                if (mBgBitmap != null) {
                    mBitmapRect.set(0, 0, mBgBitmap.getWidth(), mBgBitmap.getHeight());
                    mViewRect.set(0, 0, mViewWidth, mViewHeight);
                    mCanvasCache.drawBitmap(mBgBitmap, mBitmapRect, mViewRect, mBgPaint);
                }
     ...
     * test: setBgColor(getResources().getColor(R.color.colorBg));
     *
     * @param color color
     */
    ...
    /**
     * test: setShader(new LinearGradient(0, 0, getWidth(), getHeight(), Color.BLUE, Color.CYAN, Shader.TileMode.CLAMP));
     *
     * @param shader Shader
     */
    ...
    /**
     * test: setBgBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.app_icon));
     *
     * @param bitmap Bitmap
     */
